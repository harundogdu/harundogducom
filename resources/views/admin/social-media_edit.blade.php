...
@section('title')
    Sosyal Medya Bilgileri Güncelle
@endsection
@section('css')
@endsection
@section('content')
    <div class="page-header">
        <h3 class="page-title"> Sosyal Medya Bilgileri Güncelle </h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('social-media.index')}}">Sosyal Medya</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Sosyal Medya Bilgileri Güncelle</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="socialMediaAddForm" method="POST"
                          action="{{route('social-media.update',$social->id)}}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="href" name="href"
                                   placeholder="Sosyal Medya Adresi" value="{{$social->href}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="icon" name="icon"
                                   placeholder="Sosyal Medya İkonu" value="{{$social->icon}}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status" name="status">
                                <option @if($social->status === 0) selected @endif value="0">Pasif</option>
                                <option @if($social->status === 1) selected @endif value="1">Aktif</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="order" name="order"
                                   placeholder="Sosyal Medya Sıralaması" value="{{$social->order}}">
                            <small class="text-muted">1-999</small>
                        </div>

                        <small class="text-danger">* Zorunlu alan</small>
                        <button type="button" id="socialMediaAddButton" class="btn btn-primary mr-2 btn-block">Güncelle
                        </button>
                    </form>
                </div>
            </div>
