    ...
    <div class="achievement-cards-wrapper">
        <div class="media achievement-card">
            ...
            <div class="media-body">
                <h4 class="achievement-card-title">{{$shareData['personal']->completed_project}}+</h4>
        ...
        <div class="media achievement-card">
            ...
            <div class="media-body">
                <h4 class="achievement-card-title">{{$shareData['personal']->happy_clients}}+</h4>
        ...
        <div class="media achievement-card">
            ...
            <div class="media-body">
                <h4 class="achievement-card-title">{{$shareData['personal']->awards_recieved}}+</h4>
